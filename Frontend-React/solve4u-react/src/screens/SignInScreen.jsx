  ...
  return (
    <div className="global">
      <div className="signInBackButtonComp">
        <Link to={"/"} className="signInBackButton">
          <FaArrowLeftLong className="arrowBack" /> BACK{" "}
        </Link>
      </div>
      <div className="signInContainer">
        <div className="welcomeComp">
          ...
          <p className="textContent">
            {" "}
            We're here to streamline the way you manage your projects, offering
            powerful and intuitive tools to boost your productivity and achieve
            exceptional results.
          </p>
        ...
        <div className="loginComp">
          ...
          <form className="inputSignIn">
            <input
              type="email"
              className="inEmailInput"
              placeholder="E-mail"
              required
            />
            <input
              type="password"
              className="inPasswordInput"
