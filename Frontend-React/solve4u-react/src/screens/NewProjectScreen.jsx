          ...
          <div className="cardsRow">
            <div className="joinProjectCard">
              <p>
                ...
                Did not work?
                <br />
                If you haven't received any code, there are some possibilities
                for this:
                <br /> <br />
                Check your email inbox or check if the project invitation code
                has not expired or even if the project is still ongoing.
              </p>
              <button className="cardButtonJoin" onClick={openCardJ}>
            ...
            <div className="createProjectCard">
              <p>
                ...
                Did you like it?
                <br />
                Our platform has a comfortable interface, several organization
                options to choose from, speed and proficiency for your team to
                leverage your project, as well as everything needed to Solve4u.
              </p>
              <button className="cardButtonCreate" onClick={openCard}>
                Create Project <FaPlus className="icon" />
              </button>
