        ...
        <div className="cardsContainer">
          <div className="cardsRow">          
            <div className="joinProjectCard">
              ...
              <button className="cardButtonJoin">Join Project <FaArrowRight className="icon" /></button>
            </div>
            <div className="createProjectCard">
              ...
              <button className="cardButtonCreate">Create Project <FaPlus className="icon"/></button>
            </div>
          </div>
        </div>
      </div>
