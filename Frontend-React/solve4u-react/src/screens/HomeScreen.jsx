    ...
    <div>
      <div className="home-container">
        ...
        <div className="welcomeText">
          ...
          <h2 className="subTitleAnimation">Solve<div className="four">4</div>u</h2>
          <div className="divHomeText">
              <p className="homeText">We're here to streamline the way you manage your projects, offering  powerful and intuitive tools to boost your productivity and achieve  exceptional results. Our commitment is to provide a platform that not  only organizes your tasks but also inspires collaboration, creativity,  and innovation at every stage of your project.</p>
          </div>
        </div>
      </div>
