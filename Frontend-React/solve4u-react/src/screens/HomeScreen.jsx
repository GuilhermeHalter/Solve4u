    ...
    <div>
        ...
        <div className="welcomeText">
          ...
          <div className="divHomeText">
            <p className="homeText">
              We're here to streamline the way you manage your projects,
              offering powerful and intuitive tools to boost your productivity
              and achieve exceptional results. Our commitment is to provide a
              platform that not only organizes your tasks but also inspires
              collaboration, creativity, and innovation at every stage of your
              project.
            </p>
          </div>
        </div>
      ...
      <div className="section2" id="solutions">
        ...
        <div className="section2Text">
          ...
          <p>
            Regardless of the size or complexity of your project, we are
            committed to delivering exceptional results that add tangible value
            to your business. When you choose our solutions, you are choosing
            partnership, innovation and excellence, guided by an unwavering
      ...
      <div className="section3" id="performance">
        <div className="section3DivText">
          ...
          <p>
            Our platform is a powerful and intuitive tool designed to simplify
            project management and boost your productivity. With features that
            go beyond simply organizing tasks, we are committed to providing a
            solution that inspires collaboration, creativity and innovation at
