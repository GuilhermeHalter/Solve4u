    ...
    <div className="footerComp">
          ...
          <ul>
            <li>
              <a target="_blank" href="https://www.facebook.com/">
                <FaFacebookSquare className="facebookIcon" /> Facebook
              </a>
            </li>
            <li>
              <a target="_blank" href="https://www.instagram.com/">
                <FaInstagram className="instagramIcon" /> Instagram
              </a>
            </li>
            <li>
              <a target="_blank" href="https://twitter.com">
                <FaXTwitter className="twitterIcon" /> Twitter
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="footerCopyright">
        <a href="https://github.com/GuilhermeHalter/Solve4u/blob/main/LICENSE" className="copyright">
          Copyright © 2024 - Guilherme Halter Nunes and Wedley Silva Schmoeller.
        </a>
      </div>
    </div>
  );
